...
class Player:
    def __init__(self):
        ...
        self.score = 0
        self.scoreFont = pygame.font.Font("./res/font/imagine_font.ttf", 64)

    def scoring(self):
        score_blit = self.scoreFont.render(str(self.score), 1, (255, 255, 255))
        screen.blit(score_blit, (32, 16))
        if self.score == 10:
            print("player 1 wins!")
            exit()
...
class Enemy:
    ...
    def scoring(self):
        score_blit = self.scoreFont.render(str(self.score), 1, (255, 255, 255))
        screen.blit(score_blit, (SCR_HEI + 92, 16))
        if self.score == 10:
            print("Player 2 wins!")
            exit()
